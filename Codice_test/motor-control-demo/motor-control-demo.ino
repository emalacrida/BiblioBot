...
void loop() {
  ...
  //**** LEDs
    if(BluetoothData=='P') digitalWrite(13,HIGH);
    if(BluetoothData=='p') digitalWrite(13,LOW);
    if(BluetoothData=='Q') digitalWrite(12,HIGH);
    if(BluetoothData=='q') digitalWrite(12,LOW);
    if(BluetoothData=='R') digitalWrite(3,HIGH);
    if(BluetoothData=='r') digitalWrite(3,LOW);
    if(BluetoothData=='S') digitalWrite(2,HIGH);
    if(BluetoothData=='s') digitalWrite(2,LOW);
